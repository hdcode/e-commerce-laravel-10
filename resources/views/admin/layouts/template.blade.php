            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        <span class="app-brand-text demo menu-text fw-bolder ms-2 text-capitalize">E-TechFlection</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('allcategorys') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-home-circle"></i>
                    ...
                    <li class="menu-item">
                        <a href="{{ route('allsubcategorys') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-home-circle"></i>
