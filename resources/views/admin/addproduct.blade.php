...
@section('page_title')
Add Product - E~TechFlection
@endsection

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Page /</span> Add Product</h4>
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('storeproduct') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="product_img">Upload Products Image</label>
                        <div class="col-sm-10">
